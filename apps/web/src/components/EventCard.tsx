  ...
  return (
    <Link href={`/e/${event.id}`} className="group block">
      <motion.article
        ...
        className="relative overflow-hidden rounded-[26px] shadow-[0_30px_70px_-25px_rgba(15,23,42,0.30),0_8px_20px_-8px_rgba(15,23,42,0.10)] ring-1 ring-slate-900/5"
      >
